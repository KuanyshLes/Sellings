 ...
 */
public class SupplierEditGoodsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        back=(ImageView)view.findViewById(R.id.supplier_edit_goods_toolbar_drawer);
        gobacklistener();

        category=(Spinner)view.findViewById(R.id.supplier_edit_goods_edit_category);
        subcategory=(Spinner)view.findViewById(R.id.supplier_edit_goods_edit_subcategory);

        name=(TextInputLayout)view.findViewById(R.id.supplier_edit_goods_edit_name);
        amount=(TextInputLayout)view.findViewById(R.id.supplier_edit_goods_edit_amount);
        price=(TextInputLayout)view.findViewById(R.id.supplier_edit_goods_edit_price);

        save_btn=(Button) view.findViewById(R.id.supplier_edit_goods_edit_save_btn);
